# ====================================================================================
# Setup Project
PROJECT_NAME := provider-temporal
...
xpkg.build.provider-temporal: do.build.images
...
# This target prepares repo for your provider by replacing all "temporal"
